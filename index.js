...
function removeArtist(artist, number) {
  let removeArray = [...artist];
  removeArray.splice(number, 1);
...
function artistInfo(artist, name){
  let person = artist.filter(x => x.name == name);
